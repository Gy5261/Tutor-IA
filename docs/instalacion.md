...
La release 4.1.4 publica un instalador Windows x64. Las operaciones de Google, IA remota, colaboración y actualización requieren conexión. El acceso a IA depende de la cuenta y la configuración administrativa.
...
El estado de firma se declara en el manifiesto. La versión 4.1.4 está publicada sin firma Authenticode; consulta [seguridad](../SECURITY.md) y no desactives las protecciones del equipo como paso de instalación.
