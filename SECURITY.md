...
Consulta el estado de firma en el manifiesto de la versión descargada. `NotSigned` significa que no tiene firma Authenticode. Los hashes permiten compararlo con su manifiesto, pero no sustituyen una firma del editor. [Verificar descarga](docs/actualizaciones.md#verificar-descarga).
